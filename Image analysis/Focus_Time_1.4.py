...
# -*- coding: utf-8 -*-
"""
Created on Wed Nov 15 13:42:47 2023
...
# Paths to files
vid_num = 16 #Video 0 through 16
path_vid = '/Users/joakimpihl/Desktop/DTU/7. Semester/Bachelorprojekt/Focus sweep 2.1 sub back/run'+ str(vid_num)+'.mp4'
...
plt.savefig('/Users/joakimpihl/Desktop/DTU/7. Semester/Bachelorprojekt/Focus sweep 2.1 sub back/Fits (t_star + R)/run '+str(vid_num)+' freq.:'+str(freq)+' MHz.png', dpi=300, bbox_inches='tight')
