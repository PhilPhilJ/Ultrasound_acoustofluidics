...
df = pd.read_csv('/Users/joakimpihl/Desktop/DTU/7. Semester/Bachelorprojekt/Resonance freq - Exp 1/Resonance freq - Exp 1.csv', delimiter=';', encoding='utf-8')
...
xdata = np.linspace(1.85, 1.94, 1000)
...
ax.set_title('Reciprocal of focus time vs. frequency', fontsize='25')
