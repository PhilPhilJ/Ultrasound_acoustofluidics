...
upper_indeces = np.concatenate(( range(8,98), range(132, 149), range(260,355), range(388,434), range(516,585), range(644,694), range(772,832), range(900,949), range(1028,1080)))#, range(1540,1595), range(1668,1714)))#, range(1413,1475)))#
