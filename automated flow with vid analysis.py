...
for i in range(runs):
    ...
    while camera.IsGrabbing():
        ...
        if grabResult.GrabSucceeded():
            ...
            if (current_time - static_time) > 22 and end_fit(mean_values) and not opengate: #stops focusing and initiales run stop
                t = frame_time - imp_times[0]
                popt, pcov = curve_fit(func, frame_time[find_closest_to_zero_index(t):], mean_values[find_closest_to_zero_index(t):], p0=[1, 0.005], bounds=([0, 0], [10, 0.05]))
