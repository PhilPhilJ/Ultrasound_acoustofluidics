...
for j in range(len(frequencies)):
    ...
    estimated_focustime = 18 #This is the time + 2 seconds that is the estimated time. Estimate this for each frequency
    ...
    while camera.IsGrabbing():
        ...
        if grabResult.GrabSucceeded():
            ...
            if 12 < current_time - static_time < 13 and not opengate: # switches short cut valve to on and GTCH to off
                switchvalve()
                print("GCTH closed")
                opengate = 1
                record = True
            ...
            if 19 < current_time - static_time < 20 and opengate: # starts focusing
            ...
            if not record and current_time - static_time > 20 + estimated_focustime + 2: #stops the recording and ends the run
