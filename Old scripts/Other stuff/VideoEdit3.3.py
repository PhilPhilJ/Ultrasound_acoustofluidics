...
#%%
path = '/Users/joakimpihl/Desktop/Run (20:03:24) Unedited/'
path_out = '/Users/joakimpihl/Desktop/Run (20:03:24)/'
#%%
input_path_0 = path + 'run 0.0.mp4'
...
#%%
index_left_side = 360
index_right_side = 1212
# Paths to files
delta = 0
for vid_num in range(0, 100): #Video 0 through 10
    # Example usage:
    input_path = path + f'run 0.{vid_num}.mp4'
    path_imp_times = path + f'run 0.{vid_num} Important times.csv'
    path_times = path + 'run 0.{vid_num} Frame time.csv'
    
    output_path = path_out +'run ' + str(vid_num + delta) +'.mp4'
    output_imp_times = path_out + 'Important times ' + str(vid_num + delta) + '.csv'
    output_times = path_out + 'Time Stamps ' + str(vid_num + delta) + '.csv'
